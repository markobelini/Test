...
namespace Test {
    ...
    //% block="værdi af jordfugtigheds sensor på pin %p"
   ...
   Checks if the specified key on the ADkeyboard is pressed.
    ...
    //% block="knap %k | trykket på ADKeyboard påt pin %p"
   ...
   Checks whether the motion sensor is currently detecting any motion.
    ...
    //% block="bevægelse registreret på pin %p | detects motion"
   ...
   Checks whether the crash sensor is currently pressed.
    ...
    //% block="Setup bumper sensor at pin %p"
